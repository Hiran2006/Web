          ...
          <div className="relative">
            ...
            <div className="mb-8">
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 mb-4 md:mb-0 text-right">
            ...
            <div className="mb-8">
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 mb-4 md:mb-0 text-right order-2 md:order-1">
                  <p className="text-gray-300">
                    Worked on various projects to hone my skills in modern web
                    technologies.
                  </p>
                </div>
                <div className="w-4 h-4 bg-green-500 rounded-full z-10 order-1 md:order-2"></div>
